...
<div class="card-body">
    ...
    <script>
        ...
        paypal.Button.render({
            ...
            client: {
                sandbox: 'AVWcaB4-voGU3yxV2D3FuQHGs37bCOHkKA_4kbdjIEO65bTu2YHSnM0viVbaMkZnlma_YYrGkN0D1mrC',
                production: 'AVWcaB4-voGU3yxV2D3FuQHGs37bCOHkKA_4kbdjIEO65bTu2YHSnM0viVbaMkZnlma_YYrGkN0D1mrC'
            },
                ...
                return actions.payment.create({
                    payment: {
                        transactions: [{
                            ...
                            description: "Compra de productos a AztecaGames :$ <?php echo $cart->total() ?>",
                            custom: "Codigo"
                        }]
                    }
                });
            ...
            onAuthorize: function(data, actions) {
                return actions.payment.execute().then(function() {
                    console.log(data);
                    window.location = "AccionCarta.php?action=placeOrder";
                });
            }
        }, '#paypal-button-container');
    </script> 
